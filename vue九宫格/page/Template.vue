...
<script>
    export default {
            ...
            return {
                ...
                templates: [{
                    ...
                    },
                    {
                        ...
                        lotteryBg: '/static/img5/lotterybg.png', //抽奖背景图片
                        itemBg: '/static/img5/normal.png', //未选中背景图片
                        clickBg: '/static/img5/click.png', //立即抽奖背景图片
                        checkedBg: '/static/img5/checked.png', //已选中背景图片
                        maskBg: '/static/img5/mask.png', //弹窗背景图片
                        bgColor: '#9221bf', //皮肤底色
                        bannerImg: '/static/img5/banner.png', //标题img
                        ruleImg: '/static/img5/article.png', //规则img
                        bgMusic: '/static/img5/Richard Clayderman - 梦中的婚礼.mp3', //背景音乐
                        playImg: '/static/img5/play.png', //背景音乐播放img
                        muteImg: '/static/img5/pause.png', //背景音乐暂停img
                        titleColor: '#4d4d4d', //抽奖机会颜色
                        titleNumColor: '#ff5741', //剩余次数颜色
                        prizeColor: '#666', //奖品字体颜色
                        ruleColor: '#fff', //活动规则颜色
        ...
        mounted() {
            let index = Number(this.$route.params.id);
            index--;
            this.number = index;
            this.$nextTick(_ => {
                // 将数组重新排序，再插入高亮顺序
                ...
                .item {
                    ...
                    .img-top {
                        ...
                        img {
                            width: 60%;
                            margin: auto;
                            -webkit-transform: translateY(4/@rem);
                            -ms-transform: translateY(4/@rem);
